...
public class ItemBoat extends Item {
    ...
    public ItemStack a(ItemStack itemstack, World world, EntityHuman entityhuman) {
        ...
        double f3 = FastMath.cos(-f2 * 0.017453292F - 3.1415927F);
        double f4 = FastMath.sin(-f2 * 0.017453292F - 3.1415927F);
        double f5 = -FastMath.cos(-f1 * 0.017453292F);
        double f6 = FastMath.sin(-f1 * 0.017453292F);
        double f7 = f4 * f5;
        double f8 = f3 * f5;
        double d3 = 5.0D;
