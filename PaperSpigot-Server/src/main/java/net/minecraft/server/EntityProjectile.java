...
public abstract class EntityProjectile extends Entity implements IProjectile {
    ...
    public EntityProjectile(World world, EntityLiving entityliving) {
        ...
        this.locX -= FastMath.cos(this.yaw / 180.0 * 3.1415927) * 0.16;
        this.locY -= 0.10000000149011612D;
        this.locZ -= FastMath.sin(this.yaw / 180.0 * 3.1415927) * 0.16;
        this.setPosition(this.locX, this.locY, this.locZ);
        float f = 0.4F;

        this.motX = -FastMath.sin(this.yaw / 180.0 * 3.1415927) * FastMath.cos(this.pitch / 180.0 * 3.1415927) * f;
        this.motZ = FastMath.cos(this.yaw / 180.0 * 3.1415927) * FastMath.cos(this.pitch / 180.0 * 3.1415927) * f;
        this.motY = -FastMath.sin((this.pitch + this.l()) / 180.0 * 3.1415927) * f;
