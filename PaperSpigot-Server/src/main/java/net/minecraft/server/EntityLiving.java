...
public abstract class EntityLiving extends Entity {
    ...
    public void a(Entity entity, float f, double d0, double d1) {
        if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
            ...
            this.motX /= KnockBackConfig.knockbackFriction;
            this.motY /= KnockBackConfig.knockbackFriction;
            this.motZ /= KnockBackConfig.knockbackFriction;

            this.motX -= d0 / magnitude * KnockBackConfig.knockbackHorizontal;
            this.motY += KnockBackConfig.knockbackVertical;
            this.motZ -= d1 / magnitude * KnockBackConfig.knockbackHorizontal;

            if (this.motY > KnockBackConfig.knockbackVerticalLimit) {
                this.motY = KnockBackConfig.knockbackVerticalLimit;
            }
    ...
    protected void bF() {
        ...
        if (this.isSprinting()) {
            ...
            this.motX -= FastMath.sin(f) * 0.2F;
            this.motZ += FastMath.cos(f) * 0.2F;
        }
