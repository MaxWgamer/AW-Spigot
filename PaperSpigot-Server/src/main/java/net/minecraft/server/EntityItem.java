...
import fr.MaxWgamer.custom.hopper.HopperPusher;
...
public class EntityItem extends Entity implements HopperPusher {
    ...
    private void w() {
        ...
        Iterator<EntityItem> iterator = this.world.a(EntityItem.class, this.getBoundingBox().grow(radius, radius, radius)).iterator();
        // Spigot end
