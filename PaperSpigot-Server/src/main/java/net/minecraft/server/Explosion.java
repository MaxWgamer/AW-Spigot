...
import fr.MaxWgamer.custom.utils.FastRandom;
...
public class Explosion {
    ...
    public void a() {
        ...
        i = (int) FastMath.floor(this.posX - (double) f3 - 1.0D);
        j = (int) FastMath.floor(this.posX + (double) f3 + 1.0D);
        int l = (int) FastMath.floor(this.posY - (double) f3 - 1.0D);
        int i1 = (int) FastMath.floor(this.posY + (double) f3 + 1.0D);
        int j1 = (int) FastMath.floor(this.posZ - (double) f3 - 1.0D);
        int k1 = (int) FastMath.floor(this.posZ + (double) f3 + 1.0D);
