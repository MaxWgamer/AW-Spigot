...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public EntityArrow(World world, EntityLiving entityliving, EntityLiving entityliving1, float f, float f1) {
        ...
        if (d3 >= 1.0E-7D) {
            ...
            double f4 = (float) (d3 * 0.20000000298023224D);
    ...
    public EntityArrow(World world, EntityLiving entityliving, float f) {
        ...
        this.locX -= FastMath.cos(this.yaw / 180.0D * 3.1415927D) * 0.16D;
        this.locY -= 0.10000000149011612D;
        this.locZ -= FastMath.sin(this.yaw / 180.0D * 3.1415927D) * 0.16D;
        this.setPosition(this.locX, this.locY, this.locZ);
        this.motX = -FastMath.sin(this.yaw / 180.0D * 3.1415927D) * FastMath.cos(this.pitch / 180.0D * 3.1415927D);
        this.motZ = FastMath.cos(this.yaw / 180.0D * 3.1415927D) * FastMath.cos(this.pitch / 180.0D * 3.1415927D);
        this.motY = -FastMath.sin(this.pitch / 180.0F * 3.1415927D);
    ...
    public void t_() {
        ...
        if (this.lastPitch == 0.0F && this.lastYaw == 0.0F) {
            double f = Math.sqrt(this.motX * this.motX + this.motZ * this.motZ);
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                ...
                if (movingobjectposition.entity != null) {
                    f2 = Math.sqrt(this.motX * this.motX + this.motY * this.motY + this.motZ * this.motZ);
                    ...
                    // if (movingobjectposition.entity.damageEntity(damagesource, (float) k)) { // CraftBukkit - moved up
                        if (movingobjectposition.entity instanceof EntityLiving) {
                            ...
                            if (this.knockbackStrength > 0) {
                                f3 = Math.sqrt(this.motX * this.motX + this.motZ * this.motZ);
                                if (f3 > 0.0F) {
                                    movingobjectposition.entity.g(this.motX * (double) this.knockbackStrength * 0.6000000238418579D / f3, 0.1D, this.motZ * (double) this.knockbackStrength * 0.6000000238418579D / f3);
                                }
                            }
                    ...
                    f1 = Math.sqrt(this.motX * this.motX + this.motY * this.motY + this.motZ * this.motZ);
            ...
            this.locY += this.motY;
            this.locZ += this.motZ;
            f2 = Math.sqrt(this.motX * this.motX + this.motZ * this.motZ);
