...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
    ...
    public void m() {
        ...
        if (this.world.isClientSide) {
            f = FastMath.cos(this.bv * 3.1415927 * 2.0);
            f1 = FastMath.cos(this.bu * 3.1415927 * 2.0);
            if (f1 <= -0.3 && f >= -0.3 && !this.R()) {
        ...
        if (this.getHealth() <= 0.0F) {
            f = (this.random.nextDouble() - 0.5F) * 8.0F;
            f1 = (this.random.nextDouble() - 0.5F) * 4.0F;
            f2 = (this.random.nextDouble() - 0.5F) * 8.0F;
            ...
            this.n();
            f = 0.2F / (Math.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 10.0F + 1.0F);
            f *= FastMath.pow(2.0D, this.motY);
            if (this.bx) {
                this.bv += f * 0.5F;
            } else {
                this.bv += f;
            ...
            if (this.ce()) {
                ...
                if (this.world.isClientSide) {
                    ...
                    d4 = -FastMath.cos(this.yaw * 3.1415927F / 180.0F);
                    Vec3D vec3d1 = (new Vec3D(FastMath.sin(this.yaw * 3.1415927F / 180.0F), this.motY, d4)).a();
                    ...
                    this.bb *= 0.8F;
                    double f5 = Math.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 1.0F + 1.0F;
                    ...
                    this.bb = (float) ((double) this.bb + d9 * (0.699999988079071D / d10 / f5));
                ...
                this.bt.length = 3.0F;
                this.bt.width = 4.0F;
                f1 = (this.b(5, 1.0F)[1] - this.b(10, 1.0F)[1]) * 10.0F / 180.0F * 3.1415927F;
                f2 = FastMath.cos(f1);
                double f9 = -FastMath.sin(f1);
                float f10 = this.yaw * 3.1415927F / 180.0F;
                double f11 = FastMath.sin(f10);
                double f12 = FastMath.cos(f10);
                ...
                f3 = FastMath.sin(this.yaw * 3.1415927F / 180.0F - this.bb * 0.01F);
                double f13 = FastMath.cos(this.yaw * 3.1415927F / 180.0F - this.bb * 0.01F);
                ...
                for (int j = 0; j < 3; ++j) {
                    ...
                    double f15 = FastMath.sin(f14);
                    double f16 = FastMath.cos(f14);
                    float f17 = 1.5F;
                    float f18 = (j + 1) * 2.0F;
    ...
    public boolean a(EntityComplexPart entitycomplexpart, DamageSource damagesource, float f) {
        ...
        double f2 = FastMath.sin(f1);
        double f3 = FastMath.cos(f1);

        this.a = this.locX + (f2 * 5.0D) + ((this.random.nextDouble() - 0.5D) * 2.0D);
        this.b = this.locY + (this.random.nextDouble() * 3.0D) + 1.0D;
        this.c = this.locZ - (f3 * 5.0D) + ((this.random.nextDouble() - 0.5D) * 2.0D);
        this.target = null;
