...
import fr.MaxWgamer.custom.KnockBackConfig;
...
public abstract class EntityHuman extends EntityLiving {
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource != null) {
            this.motX = -FastMath.cos((this.aw + this.yaw) * 3.1415927F / 180.0F) * 0.1F;
            this.motZ = -FastMath.sin((this.aw + this.yaw) * 3.1415927F / 180.0F) * 0.1F;
        } else {
    ...
    public EntityItem a(ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack == null) {
            ...
            if (flag) {
                ...
                entityitem.motX = -FastMath.sin(f1) * f;
                entityitem.motZ = FastMath.cos(f1) * f;
                entityitem.motY = 0.20000000298023224D;
            } else {
                f = 0.3F;
                entityitem.motX = -FastMath.sin(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F) * f;
                entityitem.motZ = FastMath.cos(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F) * f;
                entityitem.motY = -FastMath.sin(this.pitch / 180.0F * 3.1415927F) * f + 0.1F;
                f1 = this.random.nextFloat() * 3.1415927F * 2.0F;
    ...
    public void attack(Entity entity) {
        if (entity.aD()) {
            if (!entity.l(this)) {
                ...
                double i = b0 + (EnchantmentManager.a((EntityLiving) this) / 2.5);
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        if (i > 0) {
                            entity.g(
                                    -FastMath.sin(this.yaw * 3.1415927F / 180.0F) * i * KnockBackConfig.knockbackExtraHorizontal,
                                    KnockBackConfig.knockbackExtraVertical,
                                    FastMath.cos(this.yaw * 3.1415927F / 180.0F) * i * KnockBackConfig.knockbackExtraHorizontal);
                            this.motX *= 0.6D;
                            this.motZ *= 0.6D;
