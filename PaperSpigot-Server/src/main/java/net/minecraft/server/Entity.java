...
public abstract class Entity implements ICommandListener {
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            if (this.s_() && !flag && this.vehicle == null) {
                ...
                this.M = (float) (this.M + Math.sqrt(d21 * d21 + d23 * d23) * 0.6D);
                this.N = (float) (this.N + Math.sqrt(d21 * d21 + d22 * d22 + d23 * d23) * 0.6D);
    ...
    public void a(float f, float f1, float f2) {
        ...
        if (f3 >= 1.0E-4F) {
            ...
            f *= f3;
            f1 *= f3;
            double f4 = FastMath.sin(this.yaw * 3.1415927F / 180.0F);
            double f5 = FastMath.cos(this.yaw * 3.1415927F / 180.0F);
    ...
    protected final Vec3D f(float f, float f1) {
    	double f2 = FastMath.cos(-f1 * 0.017453292F - 3.1415927F);
        double f3 = FastMath.sin(-f1 * 0.017453292F - 3.1415927F);
        double f4 = -FastMath.cos(-f * 0.017453292F);
        double f5 = FastMath.sin(-f * 0.017453292F);
