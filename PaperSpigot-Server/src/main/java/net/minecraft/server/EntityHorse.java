...
public class EntityHorse extends EntityAnimal implements IInventoryListener {
    ...
    public void g(float f, float f1) {
        if (this.passenger != null && this.passenger instanceof EntityLiving && this.cG()) {
            ...
            if (this.br > 0.0F && !this.cv() && this.onGround) {
                ...
                this.ai = true;
                if (f1 > 0.0F) {
                    double f2 = FastMath.sin(this.yaw * 3.1415927F / 180.0F);
                    double f3 = FastMath.cos(this.yaw * 3.1415927F / 180.0F);
    ...
    public void al() {
        super.al();
        if (this.bK > 0.0F) {
            double f = FastMath.sin(this.aI * 3.1415927F / 180.0F);
            double f1 = FastMath.cos(this.aI * 3.1415927F / 180.0F);
