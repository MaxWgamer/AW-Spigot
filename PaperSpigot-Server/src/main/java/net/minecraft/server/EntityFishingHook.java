...
public class EntityFishingHook extends Entity {
    ...
    public EntityFishingHook(World world, EntityHuman entityhuman) {
        ...
        this.locX -= FastMath.cos(this.yaw / 180.0F * 3.1415927F) * 0.16F;
        this.locY -= 0.10000000149011612D;
        this.locZ -= FastMath.sin(this.yaw / 180.0F * 3.1415927F) * 0.16F;
        this.setPosition(this.locX, this.locY, this.locZ);
        float f = 0.4F;

        this.motX = -FastMath.sin(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F) * f;
        this.motZ = FastMath.cos(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F) * f;
        this.motY = -FastMath.sin(this.pitch / 180.0F * 3.1415927F) * f;
    ...
    public void c(double d0, double d1, double d2, float f, float f1) {
        double f2 = Math.sqrt(d0 * d0 + d1 * d1 + d2 * d2);
        ...
        this.motY = d1;
        this.motZ = d2;
        double f3 = Math.sqrt(d0 * d0 + d2 * d2);
    ...
    public void t_() {
        ...
        if (this.az > 0) {
            ...
            if (!this.as) {
                ...
                double f1 = Math.sqrt(this.motX * this.motX + this.motZ * this.motZ);
                    ...
                    if (this.av > 0) {
                        ...
                        if (this.ax > 0) {
                            ...
                            if (this.ax <= 0) {
                                ...
                                f3 = FastMath.floor(this.getBoundingBox().b);
                                worldserver.a(EnumParticle.WATER_BUBBLE, this.locX, f3 + 1.0F, this.locZ, (int) (1.0F + this.width * 20.0F), (double) this.width, 0.0D, (double) this.width, 0.20000000298023224D, new int[0]);
                                worldserver.a(EnumParticle.WATER_WAKE, this.locX, f3 + 1.0F, this.locZ, (int) (1.0F + this.width * 20.0F), (double) this.width, 0.0D, (double) this.width, 0.20000000298023224D, new int[0]);
                                ...
                                f5 = FastMath.sin(f3);
                                f4 = FastMath.cos(f3);
                                d8 = this.locX + f5 * (float) this.ax * 0.1F;
                                d12 = FastMath.floor(this.getBoundingBox().b) + 1.0F;
                                d11 = this.locZ + f4 * (float) this.ax * 0.1F;
                            ...
                            f3 = 0.15F;
                            if (this.aw < 20) {
                                f3 = (f3 + (double) (20 - this.aw) * 0.05D);
                            } else if (this.aw < 40) {
                                f3 = (f3 + (double) (40 - this.aw) * 0.02D);
                            } else if (this.aw < 60) {
                                f3 = (f3 + (double) (60 - this.aw) * 0.01D);
                            }

                            if (this.random.nextFloat() < f3) {
                                f5 = MathHelper.a(this.random, 0.0F, 360.0F) * 0.017453292F;
                                f4 = MathHelper.a(this.random, 25.0F, 60.0F);
                                d8 = this.locX + FastMath.sin(f5) * f4 * 0.1F;
                                d12 = FastMath.floor(this.getBoundingBox().b) + 1.0F;
                                d11 = this.locZ + FastMath.cos(f5) * f4 * 0.1F;
                                block = worldserver.getType(new BlockPosition((int) d8, (int) d12 - 1, (int) d11)).getBlock();
                                if (block == Blocks.WATER || block == Blocks.FLOWING_WATER) {
    ...
    public int l() {
        if (this.world.isClientSide) {
            ...
            if (this.hooked != null) {
                ...
                this.hooked.motY += d1 * d4 + Math.sqrt(d3) * 0.08D;
                ...
                entityitem.motY = d6 * d9 + Math.sqrt(d8) * 0.08D;
